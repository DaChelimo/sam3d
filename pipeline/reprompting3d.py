...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--path', required=True, help='path to the DICOM image folder')
    parser.add_argument('-s', '--savepath', default='tempdir', help='directory to save points.json (default: tempdir)')
    args = parser.parse_args()

    os.makedirs(args.savepath, exist_ok=True)
    main(args.path, args.savepath)